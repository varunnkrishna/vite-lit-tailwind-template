        ...
        <div class="container p-6 mx-auto">
            ...
            <div class="w-full -mx-6 lg:w-2/5">
              <div class="px-6 text-center md:text-left">
                <a href="#" class="flex items-center">
                  <img
                    class="w-auto h-8 bg-white p-[2px] rounded-lg"
                    src="/images/caIndia.png"
                    alt="FastDesignlogo"
                  />
                  <span
                    class="ml-2 text-xl lg:text-3xl  font-semibold whitespace-nowrap dark:text-white"
                  >
                    Naresh Mankena & Co.
                  </span>
                </a>
                ...
                <p class="max-w-sm mt-2 text-gray-500 dark:text-gray-400">
                  Your Trusted Partner for Expert Accounting & Financial
                  Solutions
                </p>
          ...
          <div>
            <p class="text-center text-gray-500 dark:text-gray-400">
              © Naresh Mankena & Co. 2024 - All rights reserved
            </p>
          </div>
          <div>
            <p class="text-center text-gray-500 dark:text-gray-400 pt-4">
              Website Designed by Plickdesigns.com
            </p>
          </div>
        </div>
      </footer>
